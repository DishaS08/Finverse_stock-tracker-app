...
const WatchlistButton = ({
    ...
    const [added, setAdded] = useState<boolean>(initialIsWatchlisted);
    const [loading, setLoading] = useState(false);

    useEffect(() => {
        setAdded(initialIsWatchlisted);
    ...
    const handleClick = async (e: React.MouseEvent) => {
        ...
        try {
            const result = await toggleWatchlist(symbol, company, previousState);
